...
$size = $_POST['size'];
    ...
    $targetPath = $uploadDir .rand(). $fileName;
    // echo "$targetPath";


    if (move_uploaded_file($uploadedFile["tmp_name"], $targetPath)) {
        // Insert data into the database
        $sql = "INSERT INTO `chatbot_hints` (`id`, `question`, `reply`, `fileName`, `size`, `src`, `period`) VALUES (NULL, '$question', '$answer', '$fileName', '$size', '$targetPath', CURRENT_TIMESTAMP());";
